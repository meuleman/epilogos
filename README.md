...
<p>Second, you will need to create a state info file. This is a tab separated file containing various information about each of the states in the chromatin state model. 
...
<p>
The argument to this flag must be an integer <code>1, 2, or 3</code>. Note that Epilogos defaults to a saliency level of 1.
</p>
