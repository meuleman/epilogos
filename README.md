...
<h1 align="center">
  <object data="./data/manhattan_male_female_genome.pdf" type="application/pdf" width="840px">
      <embed src="./data/manhattan_male_female_genome.pdf">
          <p>This browser does not support PDFs. Please download the PDF to view it: <a href="./data/manhattan_male_female_genome.pdf">Download PDF</a>.</p>
      </embed>
  </object>
</h1>
...
<h1 align="center">
  <object data="./data/manhattan_male_female_chrX.pdf" type="application/pdf" width="840px">
      <embed src="./data/manhattan_male_female_chrX.pdf">
          <p>This browser does not support PDFs. Please download the PDF to view it: <a href="./data/manhattan_male_female_chrX.pdf">Download PDF</a>.</p>
      </embed>
  </object>
</h1>
