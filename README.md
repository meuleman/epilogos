...
<p>The output directory will contain one <code>significantLoci_*.txt</code> file. This file contains the all loci deemed to be significant below a threshold of 0.1. Each row is formatted as below.</p>
