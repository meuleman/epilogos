...
@click.command()
@click.option("-o", "--directory-one", "fileDirectory1", type=str, required=True, help="Path to directory that contains files to read from (All files in this directory will be read in)")
@click.option("-t", "--directory-two", "fileDirectory2", type=str, required=True, help="")
